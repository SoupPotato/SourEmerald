...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_BLUK_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_BlukBerryTree,
    [ITEM_NANAB_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_NanabBerryTree,
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_WepearBerryTree,
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_PinapBerryTree,
    ...
    [ITEM_QUALOT_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_QualotBerryTree,
    ...
    [ITEM_MAGOST_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_MagostBerryTree,
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_WatmelBerryTree,
    [ITEM_DURIN_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_DurinBerryTree,
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_BelueBerryTree,
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_LiechiBerryTree,
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_GanlonBerryTree,
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_SalacBerryTree,
    [ITEM_PETAYA_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_PetayaBerryTree,
    [ITEM_APICOT_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_ApicotBerryTree,
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_LansatBerryTree,
    [ITEM_STARF_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_StarfBerryTree,
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] = gObjectEventPicTable_EnigmaBerryTree,
};
...
const u16 *const gBerryTreePaletteTagTablePointers[] = {
    ...
    [ITEM_BLUK_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Bluk,
    [ITEM_NANAB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Nanab,
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Wepear,
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Pinap,
    ...
    [ITEM_QUALOT_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Qualot,
    ...
    [ITEM_MAGOST_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Magost,
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Watmel,
    [ITEM_DURIN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Belue,
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Liechi,
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Ganlon,
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Salac,
    [ITEM_PETAYA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Petaya,
    [ITEM_APICOT_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Apicot,
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Lansat,
    [ITEM_STARF_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Starf,
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Enigma,
};
